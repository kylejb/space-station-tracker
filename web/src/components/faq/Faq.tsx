            ...
            {faqVisible ? (
                <div className='w-72 z-10 fixed flex flex-col bottom-1/4 left-8 bg-zinc-900 opacity-75 text-white text-sm font-basier rounded-md p-2'>
                    ...
                    <div className='pb-1 pl-2 text-xs leading-5'>
                        <p className='pb-1'>
                            No, just your eyes! The station will look like a bright, fast-moving
                            star, but unlike an airplane, will not blink.
                        </p>
                    </div>
                    ...
                    <div className='pb-1 pl-2 text-xs leading-5'>
                        ...
                        <p className='pb-1'>
                            To find angle above horizon, hold your arm out straight and place the
                            bottom of your fist on the horizon. The height of one fist is about 10°
                            above horizon.
                        </p>
                    </div>
