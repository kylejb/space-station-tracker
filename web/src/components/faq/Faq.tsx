...
const Faq = () => {
    ...
    const renderFaq = faqVisible ? (
        <div className='w-72 z-10 gap-2 fixed flex flex-col bottom-1/4 left-8 bg-zinc-900 opacity-75 text-stone-50 font-basier rounded-md mb-1'>
        ...
        <div
            className='z-10 fixed bottom-1/4 left-8 rounded-md text-stone-50 bg-zinc-900 opacity-75 font-basier text-sm cursor-pointer p-2 mb-1'
            onClick={faqHelper}
        >
            <h2>FAQ &nbsp;»</h2>
        </div>
